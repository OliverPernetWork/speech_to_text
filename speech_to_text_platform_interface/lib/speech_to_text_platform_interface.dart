...
class SpeechListenOptions {
  ...
  SpeechListenOptions({
    ...
    /// If set the listen session will automatically stop after the
    /// specified number of seconds. This is only supported on Android.
    this.segmentTimeoutTime,
  });
}
